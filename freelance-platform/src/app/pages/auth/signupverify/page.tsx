...
const SignUpVerify = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("https://localhost:3002/api/signup/verifyCode", {
        method: "POST",
        headers: {
      ...
      router.push("/pages/auth/signupextradetails");
    } catch (err: any) {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-300">
      ...
      >
        <h2 className="text-3xl font-semibold text-center text-gray-800">Verify Your Email</h2>
